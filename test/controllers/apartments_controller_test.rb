...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { amount_of_room: @apartment.amount_of_room, area: @apartment.area, floor: @apartment.floor, number: @apartment.number } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { amount_of_room: @apartment.amount_of_room, area: @apartment.area, floor: @apartment.floor, number: @apartment.number } }
